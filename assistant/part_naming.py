...
GLOSSARY = {
    ...
    # буровое / горное (PDC bit и т.п.)
    "BIT": "долото", "WINGS": "лопасти", "WING": "лопасть", "DRILL": "буровой",
    "DRILLING": "буровой", "TRICONE": "шарошечное долото", "REAMER": "расширитель",
    "STABILIZER": "стабилизатор", "CASING": "обсадная труба", "THREAD": "резьба",
    "AUGER": "шнек", "HAMMER": "перфоратор", "ROD'": "штанга",
