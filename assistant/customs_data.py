...
HS_CODES = [
    {"code": "8413.50", "title": _("Насосы поршневые объёмные"),
     "keywords": ["насос", "pump", "гидронасос", "hydraulic pump"]},
    {"code": "8413.60", "title": _("Насосы шестерённые"),
     "keywords": ["шестерённый насос", "gear pump"]},
    {"code": "8429.51", "title": _("Погрузчики фронтальные"),
     "keywords": ["погрузчик", "loader", "wheel loader"]},
    {"code": "8431.41", "title": _("Ковши, отвалы, грейферы для строительной техники"),
     "keywords": ["ковш", "bucket", "отвал", "blade"]},
    {"code": "8431.43", "title": _("Части бурильных машин"),
     "keywords": ["буровая", "drill", "коронка"]},
    {"code": "8431.49", "title": _("Прочие части строительной техники"),
     "keywords": ["запчасть", "part", "rs", "spare"]},
    {"code": "8483.40", "title": _("Шестерни и зубчатые передачи"),
     "keywords": ["шестерня", "gear", "зубчатая"]},
    {"code": "8482.10", "title": _("Подшипники шариковые"),
     "keywords": ["подшипник", "bearing"]},
    {"code": "8421.23", "title": _("Фильтры масляные / топливные"),
     "keywords": ["фильтр", "filter", "oil filter", "fuel filter"]},
    {"code": "4011.20", "title": _("Шины пневматические для грузовых машин"),
     "keywords": ["шина", "tire", "tyre"]},
    {"code": "8536.50", "title": _("Выключатели электрические"),
     "keywords": ["выключатель", "switch", "main switch"]},
    {"code": "8537.10", "title": _("Пульты управления, щиты"),
     "keywords": ["пульт", "панель", "control panel"]},
    {"code": "9026.20", "title": _("Датчики давления"),
     "keywords": ["датчик давления", "pressure sensor"]},
    {"code": "8412.21", "title": _("Гидроцилиндры"),
     "keywords": ["гидроцилиндр", "hydraulic cylinder"]},
    {"code": "8409.99", "title": _("Прочие части ДВС"),
