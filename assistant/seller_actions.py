                ...
                "methods": [
                    {
                        ...
                        "status": "active",
                        "description": (
                            "Прикрепи файл прайса — система сама разберётся:"
                        ),
                        "features": [
                            "📚 Словарь 19 полей · RU / EN / ZH / DE",
                            "🤖 AI вызывается только для нестандартных колонок",
                            "🧬 Распознанные синонимы запоминаются — словарь растёт",
                            "🔁 Повторная загрузка применяет маппинг мгновенно",
                            "🚫 Дубликаты не плодятся (upsert по артикулу)",
                            "👀 Превью «как ляжет в базу» перед сохранением",
                        ],
                        "primary": {
                            "label": "📂 Выбрать файл",
