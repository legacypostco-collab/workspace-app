                ...
                "methods": [
                    {
                        ...
                        "status": "recommended",
                        "description": (
                            "Excel или CSV. Система распознаёт заголовки на "
                            "5 языках, AI помогает с нестандартными колонками. "
                            "Повторная загрузка обновляет цены без дубликатов."
                        ),
                        "primary": {
                            "label": "📂 Выбрать файл",
                    ...
                    },
                    {
                        ...
                        "description": (
                            ...
                            "руководство, описание 16 колонок, частые ошибки) "
                            "и тремя примерами строк."
                        ),
                        "primary": {
                            "label": "Скачать .xlsx",
