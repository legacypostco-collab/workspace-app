...
PLATFORM_BANK_ACCOUNT_TITLE = os.getenv("PLATFORM_BANK_ACCOUNT_TITLE", "").strip()
PLATFORM_BANK_IBAN = os.getenv("PLATFORM_BANK_IBAN", "").strip()
PLATFORM_BANK_ACCOUNT = os.getenv("PLATFORM_BANK_ACCOUNT", "").strip()
PLATFORM_BANK_SWIFT = os.getenv("PLATFORM_BANK_SWIFT", "").strip()
PLATFORM_BANK_BRANCH = os.getenv("PLATFORM_BANK_BRANCH", "").strip()
PLATFORM_BANK_BRANCH_CODE = os.getenv("PLATFORM_BANK_BRANCH_CODE", "").strip()
PLATFORM_BANK_CURRENCY = os.getenv("PLATFORM_BANK_CURRENCY", "").strip()
...
PLATFORM_PAYMENT_CONTACT_NAME = os.getenv("PLATFORM_PAYMENT_CONTACT_NAME", "").strip()
PLATFORM_PAYMENT_CONTACT_PHONE = os.getenv("PLATFORM_PAYMENT_CONTACT_PHONE", "").strip()
PLATFORM_PAYMENT_CONTACT_EMAIL = os.getenv("PLATFORM_PAYMENT_CONTACT_EMAIL", "").strip()
